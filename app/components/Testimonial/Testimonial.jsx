...
// sample data for projects with varients categories
...
const slides = [
  {
    ...
    name: 'Emma Johnson',
    message:
      'The service was fantastic! Highly recommed it anyone looking for top design'
  },

  {
    ...
    name: 'sophia Matine',
    message:
      'I couldnt be happier with the results.The websites is both beautiful and function  '
  },
  {
    img: '/assets/testimonial/img-3.png',
    name: 'James Smith',
    message:
      'Excellent work! The project was handleed professionally from start to finish!.'
  },
  {
    img: '/assets/testimonial/img-4.png',
    name: 'Olivaia William',
    message:
      'Everything was delivered on time,and the design exceeded my exepect my exepectations'
  },

  {
    img: '/assets/testimonial/img-5.png',
    name: 'Isaabella Brown',
    message:
...

  {
    ...
    name: 'Liam Davis',
    message:
      'The team truly understood my needs.My websites is faster and looks great!'
  }
]

const Testimonial = () => {
  const [swiperRef, setSwiperRef] = useState(null)
  // state to store the active
